...
export class TodoDataService {
  ...
  executeGetAllTodos(variable: string) {
    ...
    return this.http.get<Todo[]>(`${TODO_JPA_API_URL}/users/${variable}/todos`);
  }
  ...
  executeGetTodo(id: number) {
    ...
    return this.http.get<Todo>(`${TODO_JPA_API_URL}/users/todos/${id}`);
  }

  executeEditTodo(id: number, todo: Todo) {

    return this.http.put<Todo>(`${TODO_JPA_API_URL}/users/todos/${id}`, todo);
  }

  executeCreateTodo(userName: string, todo: Todo) {

    return this.http.post<any>(`${TODO_JPA_API_URL}/users/${userName}/todos`, todo);
  }
